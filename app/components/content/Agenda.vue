<template>
  <section id="agenda" class="agenda-section">
    ...
    <div class="agenda-list">
      <div v-for="(event, index) in sortedPerformances" :key="index" class="agenda-item">
        ...
        <div class="agenda-info-col">
          ...
          <div class="agenda-details">
            ...
            <button v-if="event.mapQuery" class="agenda-map-toggle" @click="toggleMap(index)" :title="$t('toggleMap')">
          ...
          <Transition name="fade">
            <div v-if="event.mapQuery && showMaps[index]" class="agenda-map">
              <iframe
                width="100%"
                height="150"
                style="border:0"
      ...
      <div v-if="!sortedPerformances || sortedPerformances.length === 0" class="agenda-empty">
...
const toggleMap = (index) => {
  showMaps.value[index] = !showMaps.value[index]
}

watch(performances, (newVal) => {
  if (!newVal) {
    sortedPerformances.value = []
    return
  }
